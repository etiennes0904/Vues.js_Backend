 ...
 */
final class Version20241122081429 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE content ADD upload_uuid BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', DROP cover');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE content ADD cover VARCHAR(255) NOT NULL, DROP upload_uuid');
    }
}
